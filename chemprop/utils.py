...
def multitask_mean(
    ...
    nonscale_dependent_metrics = [
        ...
        "binary_cross_entropy", "sid", "wasserstein", "f1", "mcc", "recall", "specificity", "precision",
        "true_positives", "false_positives", "true_negatives", "false_negatives", "balanced_accuracy"
    ]
